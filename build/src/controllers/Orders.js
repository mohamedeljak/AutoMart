...
const Order = {
  ...
  create(req, res) {
    ...
    const reflection = _Orders.default.create(req.body.data);
  ...
  createsignin(req, res) {
    ...
    const reflection = _Orders.default.createsignin(req.body.data);
  ...
  createcarad(req, res) {
    ...
    const reflection = _Orders.default.createcarad(req.body, token);
  ...
  createorderad(req, res) {
    ...
    const reflection = _Orders.default.createorderad(req.body, token, req.params.car_id);
   ...
   */
  getAll(req, res) {
    const reflections = _Orders.default.findAll();

    return res.status(200).send(reflections);
  },

  getAllsigninusers(req, res) {
    const reflections = _Orders.default.findAllsigninusers();

    return res.status(200).send(reflections);
  },

  getAllcarsads(req, res) {
    const reflections = _Orders.default.findAllcarsads();
  ...
  getAllorders(req, res) {
    const reflections = _Orders.default.findAllorders();
   ...
   */
  getOne(req, res) {
    const reflection = _Orders.default.findOne(req.params.id);
  ...
  getOrderOne(req, res) {
    const reflection = _Orders.default.findoderOne(req.params.id);
  ...
  getOneCar(req, res) {
    const reflection = _Orders.default.findCarOne(req.params.id);
  ...
  getA1(req, res) {
    const reflection = _Orders.default.findA1(req.query.success, req.query.lowPoint);
  ...
  getunsoldcarpricerange(req, res) {
    const reflection = _Orders.default.findsoldcarpricerange(req.query);
  ...
  getunsoldcar(req, res) {
    const reflection = _Orders.default.findsoldcars(req.query);
  ...
  update(req, res) {
    ...
    const updatedReflection = _Orders.default.update(req.params.id, req.body);
  ...
  updateorderprice(req, res) {
    ...
    */
    ...
    const updatedReflection = _Orders.default.updateorderprice(req.params.id, req.body, token);
  ...
  updatecarstatus(req, res) {
    ...
    */
    ...
    const updatedReflection = _Orders.default.updatecarstatus(req.params.id, req.body, token);
  ...
  updatecarprice(req, res) {
    ...
    */
    ...
    const updatedReflection = _Orders.default.updatecarprice(req.params.id, req.body, token);
  ...
  deletecarad(req, res) {
    ...
    const ref = _Orders.default.deletecarad(req.params.id);

    const reflectionx = _Orders.default.findCarOne(req.params.id);
  ...
  delete(req, res) {
    ...
    const ref = _Orders.default.delete(req.params.id);
