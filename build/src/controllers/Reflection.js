...
const Reflection = {
  ...
  create(req, res) {
    ...
    const reflection = _Reflection.default.create(req.body.data);
  ...
  createsignin(req, res) {
    ...
    const reflection = _Reflection.default.createsignin(req.body.data);
  ...
  createcarad(req, res) {
    ...
    const reflection = _Reflection.default.createcarad(req.body, token);
    ...
    if (keyreflection > 2) {
      ...
      console.log(_Reflection.default.createcarad.reflectioncaraddnotfound);
      return res.status(201).send({
        "status": 201,
  ...
  createorderad(req, res) {
    ...
    const reflection = _Reflection.default.createorderad(req.body, token, req.params.car_id);
  ...
  getAllsigninusers(req, res) {
    const reflections = _Reflection.default.findAllsigninusers();

    return res.status(200).send(reflections);
  },

  getAllcarsads(req, res) {
    const reflections = _Reflection.default.findAllcarsads();
  ...
  getAllorders(req, res) {
    const reflections = _Reflection.default.findAllorders();
  ...
  getOrderOne(req, res) {
    const reflection = _Reflection.default.findoderOne(req.params.id);
  ...
  getOneCar(req, res) {
    const reflection = _Reflection.default.findCarOne(req.params.id);
  ...
  getA1(req, res) {
    const reflection = _Reflection.default.findA1(req.query.success, req.query.lowPoint);
  ...
  getunsoldcarpricerange(req, res) {
    const reflection = _Reflection.default.findsoldcarpricerange(req.query);
  ...
  getunsoldcar(req, res) {
    const reflection = _Reflection.default.findsoldcars(req.query);
  ...
  updateorderprice(req, res) {
    ...
    */
    ...
    const updatedReflection = _Reflection.default.updateorderprice(req.params.id, req.body, token);
  ...
  updatecarstatus(req, res) {
    ...
    */
    ...
    const updatedReflection = _Reflection.default.updatecarstatus(req.params.id, req.body, token);
  ...
  updatecarprice(req, res) {
    ...
    */
    ...
    const updatedReflection = _Reflection.default.updatecarprice(req.params.id, req.body, token);
  ...
  deletecarad(req, res) {
    ...
    const ref = _Reflection.default.deletecarad(req.params.id);

    const reflectionx = _Reflection.default.findCarOne(req.params.id);
